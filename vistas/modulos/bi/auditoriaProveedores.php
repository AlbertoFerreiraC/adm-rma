...
<div class="content-wrapper dashboard-cyber-wrapper style-relative">
    ...
    <div id="cyberLoaderProv" class="cyber-loader-overlay">
        <div class="loader-content-hud">
            <div class="cyber-spinner-ring border-neon-purple"></div>
            <span class="hud-loading-text font-mono">[04] BI_VENDOR // AUDITANDO_DESEMPEÑO_PROVEEDORES...</span>
    ...
    <header class="cyber-header">
        <div class="header-brand-glitch">
            ...
            <h2>[04] BI_VENDOR // AUDITORÍA Y EVALUACIÓN DE PROVEEDORES</h2>
            <span class="system-badge-live-purple">VENDOR_SLA_ACTIVE</span>
        </div>
    </header>

    <section class="cyber-content mt-4">

        <!-- TARJETAS KPIS PROVEEDORES -->
        <div class="tec-metrics-row mb-4">
            <div class="cyber-kpi-card glass-panel-neon border-neon-purple">
                <div class="kpi-header-inline font-mono">
                    <span class="t-purple">PROVEEDORES // AUDITADOS</span>
                    <span>ACTIVE_VENDORS</span>
                </div>
                <div class="kpi-body-compact font-mono">
                    <h3 class="t-purple" id="kpiTotalProveedores">0</h3>
                    <p class="kpi-title-text">Proveedores en catálogo</p>
                </div>
                <div class="kpi-footer-meta font-mono">Con historial registrado</div>
            </div>

            <div class="cyber-kpi-card glass-panel-neon border-neon-red">
                <div class="kpi-header-inline font-mono">
                    <span class="text-neon-red">SLA // TIEMPO RESPUESTA</span>
                    <span class="blink-anim">🚨 LATENCY</span>
                </div>
                <div class="kpi-body-compact font-mono">
                    <h3 class="text-neon-red" id="kpiSlaProveedorPromedio">0.0d</h3>
                    <p class="kpi-title-text">Días prom. retorno garantía</p>
                </div>
                <div class="kpi-footer-meta font-mono">Desde envío hasta recepción</div>
            </div>

            <div class="cyber-kpi-card glass-panel-neon border-neon-blue">
                <div class="kpi-header-inline font-mono">
                    <span class="t-cyan">CASOS // EN PROVEEDOR</span>
                    <span>OUTSOURCED_RMA</span>
                </div>
                <div class="kpi-body-compact font-mono">
                    <h3 class="t-cyan" id="kpiCasosEnProveedor">0</h3>
                    <p class="kpi-title-text">Garantías en gestión externa</p>
                </div>
                <div class="kpi-footer-meta font-mono">Actualmente en fábrica / distribuidor</div>
            </div>

            <div class="cyber-kpi-card glass-panel-neon border-neon-yellow">
                <div class="kpi-header-inline font-mono">
                    <span class="text-neon-yellow">TOP // MAYOR INCIDENCIA</span>
                    <span class="pulse-dot-yellow"></span>
                </div>
                <div class="kpi-body-compact font-mono">
                    <h3 class="text-neon-yellow" id="kpiTopProveedorIncidencia" style="font-size:1.2rem;">--</h3>
                    <p class="kpi-title-text">Proveedor con más retornos</p>
                </div>
                <div class="kpi-footer-meta font-mono">Mayor volumen de garantías</div>
            </div>
        </div>

        <!-- GRÁFICOS EVALUACIÓN DE PROVEEDORES -->
        <div class="cyber-grid-two-unequal mb-4">
            <div class="cyber-panel-card glass-panel-neon border-neon-purple">
                <div class="panel-cyber-header">
                    <h4><span class="purple-accent">//</span> VOLUMEN DE CASOS DERIVADOS POR PROVEEDOR</h4>
                </div>
                <div class="panel-cyber-body mt-3">
                    <canvas id="chartVolumenProveedores" style="max-height: 220px; width: 100%;"></canvas>
                </div>
            </div>

            <div class="cyber-panel-card glass-panel-neon border-neon-blue">
                <div class="panel-cyber-header">
                    <h4><span class="cyan-accent">//</span> SLA PROMEDIO DE RESPUESTA (DÍAS POR PROVEEDOR)</h4>
                </div>
                <div class="panel-cyber-body mt-3">
                    <canvas id="chartSlaProveedores" style="max-height: 220px; width: 100%;"></canvas>
                </div>
            </div>
        </div>

        <!-- TABLA MATRIZ DE AUDITORÍA Y CALIFICACIÓN -->
        <div class="cyber-panel-card glass-panel-neon border-neon-purple">
            <div class="panel-cyber-header flex-header-toolbar">
                <h4><span class="purple-accent">//</span> MATRIZ EVALUATIVA Y AUDITORÍA DE PROVEEDORES</h4>
            ...
            <div class="panel-cyber-body-table mt-3 font-mono">
                <table class="cyber-mini-table" id="tablaAuditoriaProveedores">
                    <thead>
                        <tr>
                            <th>Proveedor</th>
                            <th>Contacto</th>
                            <th>Insumos en Stock</th>
                            <th>Casos RMA Derivados</th>
                            <th>SLA Promedio (Días)</th>
                            <th>Casos Pendientes</th>
                            <th>Calificación SLA</th>
                        </tr>
                    </thead>
                    <tbody>
...
<script src="vistas/js/bi/auditoriaProveedores.js"></script>