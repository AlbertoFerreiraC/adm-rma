        ...
        <div class="cyber-panel-card glass-panel-neon border-neon-cyan">
            ...
            <div class="panel-cyber-header flex-header-toolbar">
                <div class="cyber-search-box">
                    ...
                    <input type="text" id="buscarRol" class="cyber-input-search"
                        placeholder="🔍 Buscar por id, nombre de rol o estado...">
                </div>

                <button type="button" class="btn-cyber-add" id="btnNuevoRol">
                    <i class="fa fa-shield"></i> [+ DECLARAR ROL]
                </button>
            </div>

            <!-- TABLA DE ROLES -->
            <div class="panel-cyber-body-table mt-3">
                <table class="cyber-mini-table" id="tablaRoles">
                    <thead>
                        <tr>
                            <th>ID_ROL</th>
...
<!-- ==========================================
     MODAL EMERGENTE: DECLARAR / EDITAR ROL (NATIVO)
========================================== -->
<div class="custom-cyber-modal-overlay" id="modalRolOverlay" style="display: none;">
    <div class="custom-cyber-modal-container border-neon-blue">
        ...
        <div class="cyber-modal-header">
            ...
            <h4 class="modal-title font-mono" id="modalRolLabel">
                <span class="cyan-accent">//</span> <span id="lblTituloModal">[INJECT_NEW_ROLE]</span>
            </h4>
        </div>

        <form id="formRol" autocomplete="off" method="POST" onsubmit="return false;">
            <div class="modal-body font-mono">
                <input type="hidden" name="id" id="idRol">

                <div class="cyber-form-group">
                    <label class="node-label">NOMBRE DEL ROL:</label>
                    <input type="text" name="nombre" id="rol_nombre" class="cyber-input" placeholder="ej: SUPERVISOR"
                        required>
                </div>

                <div class="cyber-form-group">
                    <label class="node-label">ESTADO DEL NODO:</label>
                    <select name="estado" id="rol_estado" class="cyber-input" required>
